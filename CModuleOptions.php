<link rel="stylesheet" href="/bitrix/themes/intelma.comingsoon/jquery.datetimepicker.css" type="text/css"/>
<script src="/bitrix/js/intelma.comingsoon/jquery.js"></script>
<script src="/bitrix/js/intelma.comingsoon/jquery.datetimepicker.js"></script>
<?
global $MESS;
include(GetLangFileName($GLOBALS["DOCUMENT_ROOT"]."/bitrix/modules/intelma.comingsoon/lang/", "/install/options.php"));
    ...
    public function ShowHTML()
    {
        ...
        if(is_array($this->arOptions))
        {
            ...
            ?>     <input type="hidden" name="update" value="Y" />
                    <input type="submit" name="save" value="<?echo GetMessage("ICS_BS")?>" />
                    <input type="reset" name="reset" value="<?echo GetMessage("ICS_BR")?>" />
                    </form>
			<?
